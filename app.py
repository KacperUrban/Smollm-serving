...
async def lifespan(app):
    ...
    models["smollm-135M"], tokenizers["smollm-135M"] = load_model(
        "models/smollm-135M/", "tokenizers/smollm-135M/"
    )
    models["smollm-360M"], tokenizers["smollm-360M"] = load_model(
        "models/smollm-360M/", "tokenizers/smollm-360M/"
    )
    yield
